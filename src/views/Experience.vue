<template>
  <div class="flex flex-col items-center w-full -mx-2 ">
    ...
    <div
      class="hidden md:flex rounded-full bg-grey-light p-3 w-2/3 justify-between"
    >
      <button-radio-skill
        :text="'Front-end'"
    ...
    <div
      class="hidden md:flex justify-start flex-wrap md:w-4/5 xl:w-full  my-8"
    >
      <div
    ...
    <div class="flex md:hidden flex-wrap w-4/5 -mx-2 my-8">
      <div class="w-full py-2" v-for="(job, jix) in allJobs" :key="jix">
        <job-card :job="job"></job-card>
      </div>
    </div>
    ...
    <div class="w-1/3 flex flex-col items-center my-8">
      ...
      <div class=" flex flex-col  justify-around">
        ...
        <button-secondary
          ...
          :url="
            'https://stackoverflow.com/users/7092722/safiyya?tab=topactivity'
          "
        ></button-secondary>
